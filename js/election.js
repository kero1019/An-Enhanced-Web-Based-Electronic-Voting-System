  // Current Elections
fetch(
  "https://votingsyste-production-a0f3.up.railway.app/election/current",
  {
    method: "GET",
    headers: {
          ...
          <a class="to-votingpanel" onclick="pop()">
            <div class="election">
              ...
              <div class="currentDate">
                ...
                <p id="currentEnd">${originalDateEnd.toLocaleDateString("en-GB")}</p>
              </div>
            </div>
          </a>
        </div>`
  ...
  // Upcoming Elections
  fetch(
    "https://votingsyste-production-a0f3.up.railway.app/election/upcomming",
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json", // Adjust the content type based on your requirements
  ...
  // Past Elections
  fetch(
    "https://votingsyste-production-a0f3.up.railway.app/election/past",
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json", // Adjust the content type based on your requirements
